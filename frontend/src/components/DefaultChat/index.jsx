...
export default function DefaultChatContainer() {
  ...
  const popMsg = !window.localStorage.getItem("PreeminnetAcademy_intro");
  ...
  const MESSAGES = [
    ...
    <React.Fragment>
      ...
      >
        <div className="p-4 max-w-full md:max-w-[75%] bg-orange-100 dark:bg-stone-700 rounded-b-2xl rounded-tr-2xl rounded-tl-sm">
          <p className="text-slate-800 dark:text-slate-200 font-[500] md:font-semibold text-sm md:text-base">
            PreeminnetAcademy is more than a smarter Dropbox.
            <br />
            <br />
            PreeminnetAcademy offers two ways of talking with your data:
            <br />
            <br />
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("PreeminnetAcademy_intro")) {
      ...
      window.localStorage.setItem("PreeminnetAcademy_intro", 1);
    }
