    ...
    #swagger.requestBody = {
      ...
      content: {
        "application/json": {
          example: {
            adds: [],
            deletes: ["custom-documents/PreeminnetAcademy-hash.json"]
          }
        }
      }
    }
  ...
  app.post(
   ...
   #swagger.requestBody = {
       ...
       content: {
         "application/json": {
           example: {
             message: "What is PreeminnetAcademy?",
             mode: "query | chat"
           }
         }
       }
       ...
       "application/json": {
         schema: {
           ...
           example: {
              ...
              sources: [{title: "PreeminnetAcademy.txt", chunk: "This is a context chunk used in the answer of the prompt by the LLM,"}],
              close: true,
